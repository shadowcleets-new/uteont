    ...
    <div className="flex flex-col gap-4">
      <div className="rounded-[10px] border border-[#e8e6dc] bg-white px-5 py-4">
        ...
        <p className="text-[11px] text-[#9a988e] font-serif italic">
          Captures are also created automatically when you shelf a keyword
          or reject an idea/article. The next Research and Ideation runs
          will refuse to surface anything semantically similar.
        </p>
      </div>
      ...
      <div className="rounded-[10px] border border-[#e8e6dc] bg-white">
        ...
        {rows.length === 0 ? (
          <div className="px-5 py-6 text-[12px] text-[#9a988e] italic font-serif">
            No exclusions yet. Reject items elsewhere or add one above.
          </div>
        ) : (
